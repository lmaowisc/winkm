...
This is useful when you have access to published Kaplan-Meier (KM) curves of overall and event-free survival, but not the individual patient data,
...
of the joint distribution of *overall survival* (OS) and nonfatal *event-free survival time* (EFS). 
...
-   **KM estimates** for OS and EFS (You can scan and digitize the curves using free online tools like [WebPlotDigitizer](https://apps.automeris.io/wpd/);
